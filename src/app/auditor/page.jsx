...
const Auditor = () => {
    return (
        <main className="flex h-screen sm:w-screen items-center justify-between bg-white">
            ...
            <div className="sm:w-full sm:px-4 md:w-3/5 justify-center items-center align-middle text-center px-2 md:pl-[100px] md:mx-10 md:px-10 z-50">
                <AuditorForm />
            </div>
            <div className="sm:none h-screen relative md:w-2/5 md:justify-end ">
